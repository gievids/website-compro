...
- Frontend: React 19 + react-router-dom 7, Tailwind, framer-motion 11, lenis, sonner, lucide-react
  ...
  - Components: Navbar, Footer, Reveal/MaskedLine/SectionHeader/Eyebrow, HeroCarousel (reusable: Home hero 4 slides, Solutions header 2 slides, Network header 3 slides), Marquee, CTASection, SolutionCard, FAQ; data/solutions.js
